...
namespace lazylog
{
    class sp_readagentlogTypeB : BaseSender
    {
        public sp_readagentlogTypeB(object data)
            : base(data)
        { }
        ...
        protected override string GetData()
        {
            ...
            try
            {
                ...
                {
                    listdata.Add(new sp_readerrorlog_TypeB  //agent log 도 같은 데이터 타입임 
                    {
                        key = this.ClaUserKey,
