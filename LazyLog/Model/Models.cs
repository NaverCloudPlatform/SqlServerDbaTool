...
namespace lazylog.Model
{
    ...
    public class SqlServerLicenseData
    {
        public string loadBalancerInstanceNo { get; set; }
        public string loadBalancerInstanceName { get; set; }
        public string serverName { get; set; }
        public string serverInstanceNo { get; set; }
        public string privateIp { get; set; }
        public string serverRole { get; set; }
        public string batchRequestsPerSec { get; set; }
        public string onlineDbCnt { get; set; }
        public string cpuCnt { get; set; }
